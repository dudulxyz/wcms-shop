...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}"  style="width:20%"/><h4 class="list-group-item-heading">{product_name}</h4><p class="list-group-item-text">{product_desc}</p>',
